...
#def build(craft = 'Cube', design = [10, 10, 10]):
    #indent= [" ", "  "]
    #print('\n{}⦾[ build() ]\n'.format(indent[0]))
    ##print('{}⦾[ {} ]'.format(indent[1], craft))
    #print('{}○[ {} ]'.format(indent[1], design))
    #for parameter in design:
        #print('{}    •[ {} ]=( {} )'.format(indent[1], parameter, design[parameter]))

    #if(craft == 'Cabinet'):
        #print('\n{}○[ {} ]'.format(indent[1], craft))
        #print('{}○[ Cabinet crafting will begin with given design parameters.]\n'.format(indent[1]))
